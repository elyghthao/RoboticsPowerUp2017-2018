...
public class RobotMap {
    ...
    public static Solenoid elevatorelevatorSolenoid;
    ...
    public static void init() {
        ...
        elevatorelevatorMotor = new WPI_TalonSRX(2);
        
        
        elevatorelevatorSolenoid = new Solenoid(0, 0);
        LiveWindow.addActuator("Elevator", "elevatorSolenoid", elevatorelevatorSolenoid);
