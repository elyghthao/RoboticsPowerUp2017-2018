...
public class RobotMap {
    ...
    public static WPI_TalonSRX armswheelMotorRight;
    public static WPI_TalonSRX armswheelMotorLeft;
    ...
    public static void init() {
        ...
        armswheelMotorRight = new WPI_TalonSRX(4);
        
        
        armswheelMotorLeft = new WPI_TalonSRX(5);
