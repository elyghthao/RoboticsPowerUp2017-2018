...
public class scalePosition extends CommandGroup {
    ...
    // END AUTOGENERATED CODE, SOURCE=ROBOTBUILDER ID=PARAMETERS
    		...
    		* Code for Non-middle position
        	...
        	/**
        	 * Code for when scale is in the same position as the Robot's Position
        	 */
        	...
        	/**
        	 * Code for after robot has entered null zone
        	 */
        	addSequential (new moveElevatorAuto(0.5,500));//Move Elevator Up, to scale height
    		addSequential (new DriveStraight (.5, .5, 1));//Drive Towards Scale
    		addSequential (new shootAuto(0.5));//Shoot Out Cube
