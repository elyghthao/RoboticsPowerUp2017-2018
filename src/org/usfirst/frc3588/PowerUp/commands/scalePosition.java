...
public class scalePosition extends CommandGroup {
    ...
    public scalePosition(String robotPosition, String switchPosition) {
...
//    		
//    	}
    	if (robotPosition.charAt(0) != switchPosition,charAt(1))
    	...
    	if (robotPosition.charAt(0) == switchPosition.charAt(1)) {//position aligned with scale
