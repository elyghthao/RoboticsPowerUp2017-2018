...
public class AutoRun extends CommandGroup {
    ...
    public AutoRun(String robotPosition, String switchPosition) {

    // END AUTOGENERATED CODE, SOURCE=ROBOTBUILDER ID=PARAMETERS
    	if (robotPosition.equals("L")) {
    	...
    	if (robotPosition.equals("M")) {
    		addSequential(new DriveStraight(0.8, 1.5, 5.0));
    		if (switchPosition.charAt(0) == 'L') {
    			addSequential(new Pivot(true, 50.0, 0.6));
    			addSequential(new DriveStraight(0.8, 4.0, 12.0));
    			addSequential(new Pivot(false, 40.0, 0.6));
    			addSequential(new DriveStraight(0.8, 5.0, 12.0));
    			addSequential(new Pivot(false, -90.0, 0.6));
    		}
    		else if (switchPosition.charAt(0) == 'R') {
    			addSequential(new Pivot(false, 50.0, 0.6));
    			addSequential(new DriveStraight(0.8, 4.0, 12.0));
    			addSequential(new Pivot(true, 40.0, 0.6));
    			addSequential(new DriveStraight(0.8, 5.0, 12.0));
    			addSequential(new Pivot(true, 90.0, 0.6));
    		}
    		addSequential(new DriveStraight(0.8, 2.0, 5.0));
    	}
    	if (robotPosition.equals("R")) {
    		addSequential(new DriveStraight(0.8, 8.0, 20.0));
    		addSequential(new Pivot(false, -90.0, 0.6));
    		addSequential(new DriveStraight(0.8, 2.0, 5.0));
    	}
